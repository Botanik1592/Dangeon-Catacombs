...
zombi1 = Tupoy_zombie.new(@player)						# Инициализируем животину
zombi1.battle 																# Запускаем мочилово
@player.merge! zombi1.player									# Приводим параметры игрока в соответствии к тем, с которыми он вернулся из боя
